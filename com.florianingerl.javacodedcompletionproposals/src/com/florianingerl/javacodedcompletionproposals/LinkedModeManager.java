...
/**
 * A linked mode manager ensures exclusive access of linked position
 * infrastructures to documents. There is at most one
 * <code>LinkedModeManager</code> installed on the same document. The
 * <code>getManager</code> methods will return the existing instance if any of
 * the specified documents already have an installed manager.
 *
 * @since 3.0
 */
class LinkedModeManager {
	...
	/**
	 * Returns whether there exists a <code>LinkedModeManager</code> on
	 * <code>document</code>.
	 *
	 * @param document
	 *            the document of interest
	 * @return <code>true</code> if there exists a
	 *         <code>LinkedModeManager</code> on <code>document</code>,
	...
	/**
	 * Returns whether there exists a <code>LinkedModeManager</code> on any of
	 * the <code>documents</code>.
	 *
	 * @param documents
	 *            the documents of interest
	 * @return <code>true</code> if there exists a
	 *         <code>LinkedModeManager</code> on any of the
	 *         <code>documents</code>, <code>false</code> otherwise
	 */
	 ...
	 * <code>true</code>, any existing conflicting managers are canceled,
	 * otherwise, the method may return <code>null</code> if there are
	 * conflicts.
	 *
	 * @param documents
	 *            the documents of interest
	 * @param force
	 *            whether to kill any conflicting managers
	 * @return a manager able to cover the requested documents, or
	 *         <code>null</code> if there is a conflict and <code>force</code>
	 ...
	 *
	 * @param document
	 *            the document whose <code>LinkedModeManager</code> should be
	 *            canceled
	 */
	 ...
	 *            the model to nest
	 * @param flags
	 *            the reason and commands for leaving linked mode
	 */
	...
	/**
	 * Tries to nest the given <code>LinkedModeModel</code> onto the top of the
	 * stack of environments managed by the receiver. If <code>force</code> is
	 * <code>true</code>, any environments on the stack that create a conflict
	 * are killed.
	 *
	 * @param model
	 *            the model to nest
	 * @param force
	 *            whether to force the addition of the model
	 * @return <code>true</code> if nesting was successful, <code>false</code>
	 *         otherwise (only possible if <code>force</code> is
	 *         <code>false</code>
	 */
