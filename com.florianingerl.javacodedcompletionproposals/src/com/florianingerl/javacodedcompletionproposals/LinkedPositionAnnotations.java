...
final class LinkedPositionAnnotations extends AnnotationModel {
	 ...
	 *
	 * @param position
	 *            the new focus position, or <code>null</code> if no focus is
	 *            set.
	 ...
	 *
	 * @param position
	 *            the new exit position, or <code>null</code> if no focus is
	 *            set.
	 * @throws BadLocationException
	 *             in case <code>position</code> is invalid
	 */
	...
	/**
	 * Sets the positions that should be highlighted as the slave positions,
	 * i.e. as the positions that are linked to the focus position.
	 *
	 * @param positions
	 *            the new slave positions, or <code>null</code> if no slave
	 *            positions are to be set
	 * @throws BadLocationException
	 *             in case any of the given positions is invalid
	 */
	private void setGroupPositions(List<Position> positions) throws BadLocationException {
		...
		// Algorithm: toRemove contains all mappings at first, but all that are
		// in
		// positions get removed -> toRemove contains the difference set of
		// previous - new
		// toAdd are the new positions, which don't exist in previous = new -
		// previous
	...
	/**
	 * Sets the positions that should be highlighted as the target positions,
	 * i.e. as the positions that can be jumped to in a linked set up.
	 *
	 * @param positions
	 *            the new target positions, or <code>null</code> if no target
	 *            positions are to be set
	 * @throws BadLocationException
	 *             in case any of the given positions is invalid
	 */
	 ...
	 * <code>LinkedModeModel env</code>. The slave positions for
	 * <code>position</code> is extracted from the environment and set
	 * accordingly, the target positions are updated as well.
	 *
	 * @param env
	...
	public void switchToPosition(LinkedModeModel env, LinkedPosition position) {
		...
		try {
			...
			// will never happen as we don't actually add/remove positions from
			// the document
	...
	/**
	 * Prune <code>list</code> of all <code>LinkedPosition</code>s that do not
	 * belong to this model's <code>IDocument</code>.
	 *
	 * @param list
	 *            the list of positions to prune
	 */
	 ...
	 *
	 * @param position
	 *            the new exit position, or <code>null</code> if no exit
	 ...
	 *
	 * @param markExitTargets
	 *            the new drawing state for exit targets
	 */
	...
	/**
	 * Sets the drawing state for the focus position. Default is
	 * <code>true</code>.
	 *
	 * @param markFocus
	 *            the new drawing state for exit targets
	 ...
	 *
	 * @param markSlaves
	 *            the new drawing state for slaves
	 */
	 ...
	 *
	 * @param markTargets
	 *            the new drawing state for targets
	 */
