...
public interface ILinkedModeListener {
	...
	int NONE = 0;
	/**
	 * Flag to <code>leave</code> specifying that all nested modes should exit.
	 */
	int EXIT_ALL = 1 << 0;
	/**
	...
	int SELECT = 1 << 2;
	/**
	 * Flag to <code>leave</code> specifying that document content outside of a
	 * linked position was modified.
	 */
